...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/admin/audit-logs/route": "/api/admin/audit-logs", "/api/admin/users/route": "/api/admin/users", "/api/admin/sales-data/route": "/api/admin/sales-data", "/api/auth/change-password/route": "/api/auth/change-password", "/api/auth/login/route": "/api/auth/login", "/api/auth/me/route": "/api/auth/me", "/api/sales-months/route": "/api/sales-months", "/api/snapshots/route": "/api/snapshots", "/api/dashboard/route": "/api/dashboard", "/api/upload/route": "/api/upload", "/admin/users/page": "/admin/users", "/admin/audit-logs/page": "/admin/audit-logs", "/admin/sales-data/page": "/admin/sales-data", "/admin/snapshots/page": "/admin/snapshots", "/page": "/", "/login/page": "/login", "/dashboard/page": "/dashboard" };
